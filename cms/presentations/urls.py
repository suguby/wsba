...
from cms.presentations.views import PresentationListView, PresentationCreateView, PresentationDetailView
...
urlpatterns = [
    ...
    # url(r'^(?P<presentation>[0-9]+)/delete$', login_required(QuestionDeleteView.as_view()),
