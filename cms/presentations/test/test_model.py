...
class AnswerTest(TestCase):
    def setUp(self):
        ...
        self.presentation = Presentation.objects.create(organisation=self.organisation, name='test presentation',
                                                        slug='test-presentation')

    def test_save(self):
        presentation = Presentation.objects.create(organisation=self.organisation, name='second presentation',
